...
function launchDashboard() {
  console.log(chalk.blue('🚀 Lancement du dashboard Jarvis...'));
  console.log(chalk.green('📊 Dashboard disponible sur: http://localhost:3000'));
  console.log(chalk.yellow('💡 Utilisez "npm run dev" pour démarrer le serveur'));
}
