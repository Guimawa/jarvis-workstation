    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-900 rounded-2xl overflow-hidden shadow-glow">
        <div className="flex items-center justify-between bg-gray-800 px-4 py-2">
          ...
          <button
            onClick={() => copyToClipboard((files as any)[activeTab]?.content || '', activeTab)}
        ...
        <div className="p-4">
          <pre className="text-sm text-gray-300 overflow-x-auto">
            <code className={`language-${(files as any)[activeTab]?.language || 'javascript'}`}>
              {(files as any)[activeTab]?.content || ''}
            </code>
          </pre>
        </div>
      </div>
